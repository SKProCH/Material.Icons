...
public partial class DummyIconDataProvider  : IIconProvider
{
    ...
    /// </summary>
    private static Dictionary<DummyIconKind, object>? _cache = new();

    /// <summary>
    /// Gets the cache for the icons. The cache is used to store the parsed icons to avoid parsing them multiple times.
    /// </summary>
    public static IReadOnlyDictionary<DummyIconKind, object>? Cache => _cache;
    ...
    public static T Get<T>(DummyIconKind kind) where T : class
    {
