...
public class FeatherIconExt : MarkupExtension {
    public FeatherIconExt() { }
    public FeatherIconExt(FeatherIconKind kind) {
        Kind = kind;
    }

    public FeatherIconExt(FeatherIconKind kind, FeatherIconAnimation animation) {
        Kind = kind;
        Animation = animation;
    }

    public FeatherIconExt(FeatherIconKind kind, double iconSize, FeatherIconAnimation animation = FeatherIconAnimation.None) {
        Kind = kind;
        IconSize = iconSize;
        Animation = animation;
    }
    ...
    public FeatherIconKind Kind { get; set; }
    ...
    public FeatherIconAnimation Animation { get; set; }
