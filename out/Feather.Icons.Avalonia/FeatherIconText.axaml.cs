...
[TemplatePart("PART_Icon", typeof(FeatherIcon))]
[TemplatePart("PART_TextBlock", typeof(TextBlock))]
[TemplatePart("PART_SelectableTextBlock", typeof(SelectableTextBlock))]
public class FeatherIconText : FeatherIcon {
    public static readonly StyledProperty<Dock> IconPlacementProperty =
        DockPanel.DockProperty.AddOwner<FeatherIconText>();

    public static readonly StyledProperty<double> SpacingProperty =
        StackPanel.SpacingProperty.AddOwner<FeatherIconText>();

    public static readonly StyledProperty<Orientation> OrientationProperty =
        StackPanel.OrientationProperty.AddOwner<FeatherIconText>();

    public static readonly StyledProperty<string?> TextProperty =
        TextBlock.TextProperty.AddOwner<FeatherIconText>();

    public static readonly StyledProperty<bool> IsTextSelectableProperty =
        AvaloniaProperty.Register<FeatherIconText, bool>(nameof(IsTextSelectable));

    /// <summary>
    /// Defines the <see cref="HorizontalContentAlignment"/> property.
    /// </summary>
    public static readonly StyledProperty<HorizontalAlignment> HorizontalContentAlignmentProperty =
        ContentControl.HorizontalContentAlignmentProperty.AddOwner<FeatherIconText>();

    /// <summary>
    /// Defines the <see cref="VerticalContentAlignment"/> property.
    /// </summary>
    public static readonly StyledProperty<VerticalAlignment> VerticalContentAlignmentProperty =
        ContentControl.VerticalContentAlignmentProperty.AddOwner<FeatherIconText>();
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e) {
        ...
        if (Classes.Count > 0) {
            ...
            if (filteredClasses.Length > 0) {
                ...
                var icon = e.NameScope.Get<FeatherIcon>("PART_Icon");
