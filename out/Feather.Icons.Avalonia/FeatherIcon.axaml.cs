...
public class FeatherIcon : TemplatedControl, IImage {
    #region Properties

    public static readonly StyledProperty<FeatherIconKind?> KindProperty
        = AvaloniaProperty.Register<FeatherIcon, FeatherIconKind?>(nameof(Kind));

    /// <summary>
    /// Gets or sets the icon to display.
    /// </summary>
    public FeatherIconKind? Kind {
        get => GetValue(KindProperty);
        set => SetValue(KindProperty, value);
    }

    public static readonly StyledProperty<double> IconSizeProperty =
        AvaloniaProperty.Register<FeatherIconText, double>(nameof(IconSize), defaultValue: double.NaN);
    ...
    public static readonly StyledProperty<FeatherIconAnimation> AnimationProperty
        = AvaloniaProperty.Register<FeatherIcon, FeatherIconAnimation>(nameof(Animation));

    /// <summary>
    /// Gets or sets the icon animation to play.
    /// </summary>
    public FeatherIconAnimation Animation {
        get => GetValue(AnimationProperty);
        set => SetValue(AnimationProperty, value);
    }
    
    public static readonly DirectProperty<FeatherIcon, GeometryDrawing> DrawingProperty =
        AvaloniaProperty.RegisterDirect<FeatherIcon, GeometryDrawing>(
            nameof(Drawing),
            o => o.Drawing);
    ...
    private void SetGeometry() {
        Drawing.Geometry = Kind is null ? null : FeatherIconDataProvider.Get<Geometry>(Kind.Value);
    }
