...
public class LineIconIconTextExt : LineIconIconExt {
    public LineIconIconTextExt() { }

    public LineIconIconTextExt(LineIconIconKind kind) : base(kind)
    {
    }

    public LineIconIconTextExt(LineIconIconKind kind, LineIconIconAnimation animation) : base(kind, animation)
    {
    }

    public LineIconIconTextExt(LineIconIconKind kind, double iconSize, LineIconIconAnimation animation = LineIconIconAnimation.None) : base(kind, iconSize, animation)
    {
    }

    public LineIconIconTextExt(LineIconIconKind kind, string text, LineIconIconAnimation animation = LineIconIconAnimation.None)
        : base(kind, animation)
    {
        Text = text;
    }

    public LineIconIconTextExt(LineIconIconKind kind, double iconSize, string text, LineIconIconAnimation animation = LineIconIconAnimation.None)
        : base(kind, iconSize, animation)
    {
        Text = text;
    }

    public LineIconIconTextExt(LineIconIconKind kind, double iconSize, Dock iconPlacement, string text, LineIconIconAnimation animation = LineIconIconAnimation.None)
        : base(kind, iconSize, animation) {
    ...
    public override object ProvideValue(IServiceProvider serviceProvider) {
        ...
        var result = new LineIconIconText();
        ...
        if (Text is IBinding textBinding) result.Bind(LineIconIconText.TextProperty, textBinding);
