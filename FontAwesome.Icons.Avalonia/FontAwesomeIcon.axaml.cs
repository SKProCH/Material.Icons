...
namespace FontAwesome.Icons.Avalonia {
    ...
    public class FontAwesomeIcon : TemplatedControl, IImage {
        #region Properties

        public static readonly StyledProperty<FontAwesomeIconKind?> KindProperty
            = AvaloniaProperty.Register<FontAwesomeIcon, FontAwesomeIconKind?>(nameof(Kind));
        ...
        public static readonly StyledProperty<double> IconSizeProperty =
            AvaloniaProperty.Register<FontAwesomeIconText, double>(nameof(IconSize), defaultValue: double.NaN);
        ...
        public static readonly StyledProperty<FontAwesomeIconAnimation> AnimationProperty
            = AvaloniaProperty.Register<FontAwesomeIcon, FontAwesomeIconAnimation>(nameof(Animation));
        ...
        public static readonly DirectProperty<FontAwesomeIcon, GeometryDrawing> DrawingProperty =
            AvaloniaProperty.RegisterDirect<FontAwesomeIcon, GeometryDrawing>(
                nameof(Drawing),
                o => o.Drawing);
        ...
        private void SetGeometry() {
            Drawing.Geometry = Kind is null ? null : FontAwesomeIconDataProvider.Get<Geometry>(Kind.Value);
        }
